---
title: "Coding Style"
description: "Code formatting, documentation, and type safety standards for browser-jet-pilot contributors."
keywords: ["coding style", "prettier", "eslint", "typescript", "formatting"]
---
