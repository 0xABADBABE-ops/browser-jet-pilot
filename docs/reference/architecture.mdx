---
title: "Architecture"
description: "System architecture for MCP Browser Server, BrowserAgent, BrowserSkill, and MCP clients."
...
flowchart LR
  ...
  BS -->|MCP JSON-RPC| MB["MCP Browser Server<br/>(stdio or HTTP)"]
  BA -->|MCP JSON-RPC| MB
  MC -->|MCP JSON-RPC| MB
