...
Configure Claude Desktop to connect to this server. See [/guides/integrations](/guides/integrations) for MCP client configuration.
...
If you run into issues, check the dedicated [Troubleshooting guide](/guides/troubleshooting) for common problems and solutions.
